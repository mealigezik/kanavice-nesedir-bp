...
let notum = `Note: If your subtotal higher than ${shippingFreePrice}$, your shipping will be free! :) `;
document.querySelector("#nnote").innerText = notum;
